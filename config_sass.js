module.exports = {
	...
	excludeFiles: [
		/\.(wp|ios).(scss)$/i,
		/*
		/(action-sheet|backdrop|badge|card|checkbox|chip|datetime|fab|infinite-scroll|modal|note|picker|popover|radio|range|refresher|searchbar|segment|select|show-hide-when|slides|split-pane|tabs|toggle|virtual-scroll)/i,
		*/
	],
